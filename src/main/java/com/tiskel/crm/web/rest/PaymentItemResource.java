...
public class PaymentItemResource {
    ...
    public ResponseEntity<PaymentItemDTO> updatePaymentItem(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, paymentItemDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PaymentItemDTO> partialUpdatePaymentItem(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, paymentItemDTO.getId().toString())
        );
    }
