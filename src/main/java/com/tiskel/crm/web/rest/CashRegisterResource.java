...
public class CashRegisterResource {
    ...
    public ResponseEntity<CashRegisterDTO> updateCashRegister(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, cashRegisterDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<CashRegisterDTO> partialUpdateCashRegister(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, cashRegisterDTO.getId().toString())
        );
    }
